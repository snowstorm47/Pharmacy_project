              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 17), // Add spacing between the texts
                          Text(
                            'Income List',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                    ...
                    // Buttons for filter and add income
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              _showAddIncomeDialog(context); // Call _showAddIncomeDialog method
                            },
                            icon: Icon(Icons.add),
                            label: Text(
                              'Add Income',
