...
class reportSGenerate extends StatefulWidget {
  const reportSGenerate({super.key});

  @override
  State<reportSGenerate> createState() => _reportGenerateState();
}

class _reportGenerateState extends State<reportSGenerate> {
  @override
