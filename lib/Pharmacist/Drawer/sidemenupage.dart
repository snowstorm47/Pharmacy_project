...
class SideMenuPagePharmacict extends StatefulWidget {
  const SideMenuPagePharmacict({super.key});

  @override
  State<SideMenuPagePharmacict> createState() => _SideMenuPageState();
}

class _SideMenuPageState extends State<SideMenuPagePharmacict> {
