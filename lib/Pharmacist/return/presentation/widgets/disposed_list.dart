...
import 'package:clean_a/return/data/model/disposed_data.dart';
import 'package:clean_a/shared/utility/responsiveDrawer.dart';
import 'package:flutter/material.dart';

import '../../../Drawer/sidemenupage.dart';

class DisposedListP extends StatefulWidget {
  const DisposedListP({super.key});

  @override
  State<DisposedListP> createState() => _DisposedListState();
}

class _DisposedListState extends State<DisposedListP> {
  ...
  Widget _buildDataRow(DisposedListData data, bool isTablet) {
    return Container(
      decoration: BoxDecoration(
