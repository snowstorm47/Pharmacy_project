...
class ListOfStockPageP extends StatefulWidget {
  const ListOfStockPageP({super.key});

  @override
  ListOfStockPageState createState() => ListOfStockPageState();
}

class ListOfStockPageState extends State<ListOfStockPageP> {
