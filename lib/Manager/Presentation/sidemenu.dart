...
class SideMenuPageManager extends StatefulWidget {
  const SideMenuPageManager({super.key});

  @override
  State<SideMenuPageManager> createState() => _SideMenuPageState();
}

class _SideMenuPageState extends State<SideMenuPageManager> {
