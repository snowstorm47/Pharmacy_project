...
class GeneratedSReportsCashier extends StatefulWidget {
  const GeneratedSReportsCashier({super.key});

  @override
  GeneratedSReportsState createState() => GeneratedSReportsState();
}

class GeneratedSReportsState extends State<GeneratedSReportsCashier> {
