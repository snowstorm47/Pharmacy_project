...
class ReportGenerateCashier extends StatefulWidget {
  const ReportGenerateCashier({super.key});

  @override
  State<ReportGenerateCashier> createState() => _ReportGenerateState();
}

class _ReportGenerateState extends State<ReportGenerateCashier> {
