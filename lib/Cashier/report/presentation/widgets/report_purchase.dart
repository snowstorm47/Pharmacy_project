...
class ReportPGenerateCashier extends StatefulWidget {
  const ReportPGenerateCashier({super.key});

  @override
  State<ReportPGenerateCashier> createState() => _ReportPGenerateState();
}

class _ReportPGenerateState extends State<ReportPGenerateCashier> {
  @override
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          'Generate Report',
                          style: TextStyle(
                              fontSize: fontSizeButton, color: Colors.white),
                        ),
                      ),
                    ],
                  ),
