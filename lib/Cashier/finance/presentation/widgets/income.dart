...
class IncomePageCashier extends StatefulWidget {
  const IncomePageCashier({super.key});

  @override
  State<IncomePageCashier> createState() => _IncomePageState();
}

class _IncomePageState extends State<IncomePageCashier> {
