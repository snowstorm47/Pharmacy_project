...
import 'package:clean_a/branch_M/Provider/refillprovider.dart';
//import 'package:clean_a/branch_M/Provider/refillrequestprovider.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<CashierProvider>(
            create: (_) => CashierProvider()),
        ChangeNotifierProvider<PharmacistProvider>(
        ...
        ChangeNotifierProvider<BranchProvider>(create: (_) => BranchProvider()),
            //ChangeNotifierProvider<RefillRequestProvider>(create: (_) => RefillRequestProvider()),
        ChangeNotifierProvider<Authprovider>(create: (_) => Authprovider()),
        ChangeNotifierProvider<imageProvider>(create: (_) => imageProvider()),
        ChangeNotifierProvider<registrationProvider>(
            create: (_) => registrationProvider()),
        ChangeNotifierProvider<CustomerProvider>(
            create: (_) => CustomerProvider()), // Added MedicineProvider
